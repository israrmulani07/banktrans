...
export const DebitTrans = () => {
    ...
    const handleDebit = () => {                                                     //we create payload 
        const currTrans = {
            cardtype,
            amnt,
            transtype: 'D'
            ...
            <Card sx={{ height: 300, marginTop: 1 }}>
                <CardContent>
                    ...
                    <Grid container spacing={2} align="center">
                        <Grid item xs={12}><h2>Debit Transaction</h2></Grid>
                        ...
                        <Grid item xs={2}><Button onClick={handleDebit} variant='contained' color='secondary' sx={{ height: 55 }} fullWidth>Debit</Button></Grid>
